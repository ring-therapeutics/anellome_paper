...
*Overview of study design. Fifteen transfusion recipients paired with one or more blood donors  received a blood transfusion following surgery. Recipient samples were collected post-transfusion over a period of 280 days. Pan-anellovirus PCR-positive samples in red.*
...
ggsave(here("figures",
            "fig2a.pdf"), plot = g1, units = "mm", height = 160, width = 448, scale = 1)
g1
```
...
color_palette <- c("#3B4992", "#004512", "#E71E26", "#F59999",
                   "#F58020", "#CAB3D6", "#FDBF6F", "#B3D88B",
                   "#1979B5", "#B15B29", "#F9F49B", "#33A148",
                   "#6B3F98", "#A5CEE4")
...
dcolor_palette <- c("#3B4992", "#E71E26", "#F59999",
                    "#F58020", "#CAB3D6",
                    "#1979B5", "#B15B29", "#33A148",
                    "#6B3F98", "#A5CEE4")
...
g2 <- ggarrange(donor_orf_conunt_p, recip_orf_count_p, align = "h", widths = c(.3, .7))

ggsave(here("figures",
            "fig2b.pdf"), plot = g2, units = "mm", height = 172, width = 441, device = cairo_pdf, scale = 1)
g2
```